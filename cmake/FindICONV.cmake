...
" ICONV_WORKS)
      ...
      if(NOT DEFINED ICONV_WORKS)
        # Guess value for ICONV_WORKS based on the name of the target system.
        if(NOT ICONV_FIND_QUIETLY)
          message(STATUS "Performing Test ICONV_WORKS")
        endif()
        if(CMAKE_SYSTEM_NAME STREQUAL "AIX" OR CMAKE_SYSTEM_NAME STREQUAL "HP-UX")
          set(ICONV_WORKS FALSE CACHE BOOL "Whether iconv() works on the target system (set to false for AIX and HP-UX by default).")
        else()
          set(ICONV_WORKS TRUE CACHE BOOL "Whether iconv() works on the target system (set to true by default).")
        endif()
        if(NOT ICONV_FIND_QUIETLY)
          if(ICONV_WORKS)
...
" ICONV_SUPPORTS_UNICODE)
      ...
      if(NOT DEFINED ICONV_SUPPORTS_UNICODE)
        ...
        if(HAVE_GNU_ICONV OR CMAKE_SYSTEM MATCHES "SunOS-(2\\.9|2\\.1[0-9])")
          set(ICONV_SUPPORTS_UNICODE 1 CACHE INTERNAL "Whether iconv() supports conversion between UTF-8 and UTF-{16,32}{BE,LE} on the target system.")
          if(NOT ICONV_FIND_QUIETLY)
            message(STATUS "Performing Test ICONV_SUPPORTS_UNICODE - success")
          endif()
        else()
          set(ICONV_SUPPORTS_UNICODE FALSE CACHE BOOL "Whether iconv() supports conversion between UTF-8 and UTF-{16,32}{BE,LE} on the target system (set to false by default).")
          if(NOT ICONV_FIND_QUIETLY)
